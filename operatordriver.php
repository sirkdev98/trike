...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Driver / Operator Data</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
          <li class="breadcrumb-item"><a href="#">Transactions</a></li>
          <li class="breadcrumb-item active">Driver Opertor Data</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Tricycle Driver and Operators</h5>
              
<button type="button" class="btn btn-success">+ ADD OPERATOR/DRIVER</button>
