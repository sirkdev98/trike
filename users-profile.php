...
<body>
  ...
  <?php 
                    ...
                    $sql = "SELECT * from tbl_user where id = $cidd";
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fname" value="<?php echo $first_name; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Middle Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="mname" value="<?php echo $middle_name; ?>">
                      </div>
                    </div>
                    <div class="row mb-3">
                      <label for="fullName" class="col-md-4 col-lg-3 col-form-label">Last Name</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" class="form-control" id="fullName" value="<?php echo $last_name; ?>">
                      </div>
                    </div>
                    ...
                    <div class="text-center">
                      ...
                      <button type="submit" class="btn btn-primary" name="profileedit" disabled>Save Changes</button></a>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form method="POST">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input type="password" class="form-control" id="currentPassword" name="cpw" value="" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input type="password" class="form-control" id="newPassword" name="newpw" value="" required>
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input  type="password" class="form-control" id="renewPassword" name="confirmpw" required>
                      </div>
                    </div>
...
if ($newpw == $confirmpw) {
  ...
  $sql = "UPDATE `tbl_user` SET `password` = '$newpw' WHERE `tbl_user`.`id` = '2'";
